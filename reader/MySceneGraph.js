...
MySceneGraph.prototype.parseComponents = function(rootElement) {
	...
	let games = elems[0].getElementsByTagName('game');
	for (let game of games) {
		if (this.game) return "more than one game component present.";
		this.game = new StateManager();
		this.game.pushState(new Menu(this.game, this.scene, new Overlay(), this.scene.interface.gui));
	}
